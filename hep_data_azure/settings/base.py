...
ARTIFACT_STORAGE_BACKEND = env("ARTIFACT_STORAGE_BACKEND", "local")
PLOT_RUNNER_ROOT = env("PLOT_RUNNER_ROOT", str(BASE_DIR / "tmp" / "plot-runner"))
...
PLOT_RUNNER_DRIVER = env("PLOT_RUNNER_DRIVER", "python -m portal.plot_driver")
PLOT_DRIVER_EXECUTOR = env("PLOT_DRIVER_EXECUTOR", "fake")
